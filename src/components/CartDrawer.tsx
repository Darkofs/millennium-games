      ...
      const options = {
        ...
        handler: function (response: any) {
          ...
          if (checkoutResult.success && checkoutResult.keys) {
            ...
            // Redirect to WhatsApp after confirming purchase
            setTimeout(() => {
              window.location.href = "https://wa.me/message/WXU5NCOSMGVRE1";
            }, 3000);
          } else {
                  ...
                  <div className="pt-4 space-y-2.5">
                    ...
                    {currentInvoice && (
                      <button
                        ...
                        className="w-full py-3 px-4 rounded-full font-bold text-slate-950 bg-amber-400 hover:bg-amber-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all cursor-pointer text-xs uppercase tracking-wider"
                      >
                        <span>🧾</span>
